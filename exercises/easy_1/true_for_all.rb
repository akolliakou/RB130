# In the previous exercise, you developed a method called any? that is 
# similar to the standard Enumerable#any? method for Arrays (our actual 
# solution works with any Enumerable collection). In this exercise, you will 
# develop its companion, all?.
...
# a value of true for every element, then #all? returns true. Otherwise, 
# #all? returns false. Note in particular that #all? will stop searching the 
